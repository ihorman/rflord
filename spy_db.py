...
SPY_DEVICES = [
    ...
    # Audio bugs / wiretaps
    (35, 45, "VHF Audio Bug", "🎙️", 0),
    (72, 76, "VHF Audio Bug", "🎙️", 0),
    (150, 174, "VHF Audio Bug", "🎙️", 0),
    (400, 470, "UHF Audio Bug", "🎙️", 0),
    (2400, 2483, "2.4GHz Audio Bug", "🎙️", 0),
    ...
    (0, 30, "Keylogger RF Emission", "⌨️", 0),
    
    # Satellite phones (could be used for covert comms)
    (1616, 1626, "Iridium Sat Phone", "🛰️", 2),
    (1980, 2010, "Inmarsat Sat Phone", "🛰️", 2),
    (1626, 1660, "Globalstar Sat Phone", "🛰️", 2),
